...
"    background-color: whitesmoke;font-family: Roboto, sans-serif;font-size:20px; '>");
            out.println("<center><div><h1>-Tabla General De Usuarios-</h1></center>");
        ...
        if (count==0){
                ...
                out.println("<center><h1>No hay Datos para Mostrar</h1></center>");
            ...
            out.println("</tbody>"
                    + "</table>"
                    + "<br>"
                    + "<center><a href='index.html'>Regresar al Formulario</a><center>");
            out.println("</body>");
            out.println("</html>");
        }
    }
